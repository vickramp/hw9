...
public class Map extends Fragment implements OnMapReadyCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        com.places.vickr.details.CustomAutoCompleteAdapter adapter =  new com.places.vickr.details.CustomAutoCompleteAdapter(getContext() );
    ...
    private AdapterView.OnItemClickListener onItemClickListener =
            new AdapterView.OnItemClickListener(){
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    pid=((com.places.vickr.details.Place)adapterView.
                            getItemAtPosition(i)).getPlaceId();
                    dn=((com.places.vickr.details.Place)adapterView.
